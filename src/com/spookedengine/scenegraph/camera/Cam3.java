...
import com.spookedengine.math.FastMath;
import com.spookedengine.math.Plane;
import com.spookedengine.math.Vec3;
import com.spookedengine.scenegraph.collision.BoundingSphere;
 ...
 * @author Oliver Winks
 */
public class Cam3 extends Cam<Vec3> {
    ...
    public Cam3(Viewport viewport, float fov, float nearClip, float farClip) {
        super(viewport);
    ...
    @Override
    public boolean isVisible(BoundingVolume<Vec3> bounds) {
        if(bounds instanceof BoundingSphere)
            return isVisible((BoundingSphere<Vec3>) bounds);
...
//            return isVisible((AABoundingBox) bounds);
    ...
    private boolean isVisible(BoundingSphere<Vec3> bounds) {
        for(int i=0; i<planes.length; i++) {
