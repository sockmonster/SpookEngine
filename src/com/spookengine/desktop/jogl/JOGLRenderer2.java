 ...
 * @author Oliver Winks
 */
public class JOGLRenderer2 extends Renderer {
    private static final Logger logger = Logger.getLogger(JOGLRenderer2.class.getName());
    private static JOGLRenderer2 instance;
    ...
    public static JOGLRenderer2 getInstance(GL2 gl) {
        if(instance == null) {
            instance = new JOGLRenderer2();
...
//        gl.glBindTexture(GL2.GL_TEXTURE_2D, tex.texPtr[0]);
...
//            GLUtils.texImage2D(GL2.GL_TEXTURE_2D, 0, tex.getBitmaps()[i], 0);
//            
//            // TODO: TO SLOW TO USE AT THE MO
//            //gl.glTexImage2D(GL2.GL_TEXTURE_2D, i, GL2.GL_RGBA, tex.getWidth(i), tex.getHeight(i), 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, tex.getData(i));
//        }
        //////////////////////////////////////////////////////////////////////////////////////////////////////
    }
